...
export declare const resolveRetryParticipant: (existingParticipant: string | undefined, remoteJid: string, retryNode?: BinaryNode) => RetryParticipantResolution;
...
export declare const __testing: {
    resolveRetryParticipant: (existingParticipant: string | undefined, remoteJid: string, retryNode?: BinaryNode) => RetryParticipantResolution;
};
