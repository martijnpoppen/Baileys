...
export const resolveRetryParticipant = (existingParticipant, remoteJid, retryNode) => {
...
export const makeMessagesRecvSocket = (config) => {
    ...
    const localMsgRetryCache = shouldCloseMsgRetryCache ? msgRetryCache : undefined;
    ...
    const localCallOfferCache = shouldCloseCallOfferCache ? callOfferCache : undefined;
